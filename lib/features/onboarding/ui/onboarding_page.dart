        ...
        children: [
          Expanded(
            child: PageView.builder(
              ...
              onPageChanged: (page) =>
                  ref.watch(onboardingNotifier.notifier).updatePage(page),
              itemCount: ref
                  .watch(onboardingNotifier)
                  .onboardingTitleList
                  .length,
          ...
          OnboardingIndicatorRow(
            size: 4,
            currentIndex: (ref.watch(onboardingNotifier).currentPage ?? 0)
                .toInt(),
          ),
          (AppConstants.deviceHeight * 0.265).sbH,
          AppButton(
            onTap: () {
              if (ref.watch(onboardingNotifier).currentPage == 3) {
            ...
            buttonColor: ref.watch(onboardingNotifier).currentPage == 3
                ? AppColors.primaryOrange
                : AppColors.slateCharcoal06,
            textColor: ref.watch(onboardingNotifier).currentPage == 3
                ? AppColors.neutralWhite
                : AppColors.slateCharcoalMain,
            title: ref.watch(onboardingNotifier).currentPage == 3
            ...
            buttonIcon: SvgPicture.asset(
              ...
              height: 24.ah,
              width: 24.aw,
              color: ref.watch(onboardingNotifier).currentPage == 3
                  ? AppColors.neutralWhite
                  : AppColors.slateCharcoalMain,
            ),
          ),
