abstract class AppStrings {
  ...
  static const welcomeBackSmall = 'Welcome back,';
  ...
  static const weekdaysNames = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];
  static const todaysTask = "Today\'s Task";
  static const communitySub = "Connect with other parents, carers and more.";
  static const myGroups = "My Groups";
  static const sosCircle = "SOS Circle";
  static const discover = "Discover";
  static const saved = "Saved";
  static const trending = "Trending";
  static const mentalHealthSupport = "Mental Health Support";
  static const mentalHealthSupportInfo = "A safe space to discuss mental health challenges, share coping strategies, and support each other.";
  static String trendingMembers(String count) => "$count Members";
  static String trendingPostCount(String count) => "$count new posts today";
  static String postCount(String count) => "$count new posts";
  static const joinGroup = "Join Group";
  static const popularForums = "Popular Forums";
  static const post = "Post";
  static String postReplies(String count) => "$count replies";
  static String postViews(String count) => "$count views";
  static String postLastReply(String time) => "last reply: $time";
  static String childRoutine(String child) => "$child\'s Routine";
  static const viewFullRoutine = "View full routine";
  static const tasks = "Tasks";
  static const messages = "Messages";
  static const marketPlace = "Market Place";
  static String forChild(String child) => "For $child";
  static const viewTask = "View Task";
  static const searchMessagesHint = "Search messages...";
  static const pinned = "Pinned";
  static const recent = "Recent";
  static String postInfoText({required String forum}) => "New post in $forum:";
  static String replyInfoText({required String forum}) => "replied to your post in $forum";
  static String reactionInfoText({required String forum}) => "reacted to your post in $forum";
  static const viewPost = "View Post";
  static const viewComment = "View Comment";
  static const sent = "Sent";
  static const received = "Received";
  static const activeOffers = "Active Offers";
  static const type = "Type";
  static const status = "Status";
  static const offersType = ['Type', 'Type1', 'Type2'];
  static const offersStatus = ['Status', 'Status1', 'Status2'];
  static String offersTypeStatus(String status) => "Offer $status";
  static const pickup = "Pickup";
  static const payViaEscrow = "Pay via Escrow";
  static const replyHintText = "Write your reply";
  static const sos = "SOS";
  static const createAGroup = "Create a Group";
  static const connectWithPeople = "Connect with people who understand.";
  static const start = "Start";
  static const yourGroups = "Your Groups";
  static const seeAll = "See All";
  static const recentActivity = "Recent Activity";
  static const more = "More";
  static const safetyFirst = "Safety First";
  static const safetyFirstInfo = "SOS Circles allow you to quickly alert trusted contacts in case of emergency. Add people you trust who can respond when needed.";
  static const addEmergencyResponder = "Add Emergency Responder";
  static const privacySettings = "Privacy Settings";
  static const sharePreciseLocation = "Share precise location";
  static const sharePreciseLocationInfo = "Your exact location will be shared with your responders when you activate the SOS";
  static const alertTypes = "Alert Types";
  static const message = "Message";
  static const sosMessageInfo = "Sends emergency text to all your contacts";
  static const seeMessageTemplates = "See message templates";
  static const call = "Call";
  static const sosCallInfo = "Automatically calls your primary contact when SOS is activated";
